...
The logic for \textbf{CSQ$_\vdash$} and \textbf{SND} differs from the
...
\begin{theorem}
  ...
  awareness models making true \tmtextbf{CSQ}$_{\vdash'}$ and
  \tmtextbf{SND} for a suitable logic $\vdash'$.
\end{theorem}
\begin{proof}
