\begin{proof}
  ...
  \begin{enumerateroman}
    \item \label{hybprop1} $\sim_{\forall}$ is an equivalence relation
    \item If $\mathbbm{M}, v \vDash A : \psi$ then $\mathbbm{M}, v
      \vDash \Box \psi$     
    \item $R_{\Box} \subseteq \sim_{\forall}$
    \item \label{hybprop4}In each equivalence class specified by $\sim_{\forall}$, there is at
